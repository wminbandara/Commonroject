    ...
    public partial class FormBranchwiseReports : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objDAL = new ClassPODAL();
                gridControl4.DataSource = null;
                if (objDAL.retreiveBranchwseSalesByInvoice(objBAL).Tables[0].Rows.Count > 0)
                {
                    gridControl4.DataSource = objBAL.DtDataSet.Tables[0];
                    gridView4.Columns["CreatedDate"].DisplayFormat.FormatString = "yyyy/MM/dd hh:mm tt";
                    gridView4.OptionsView.ColumnAutoWidth = false;
        ...
        private void button66_Click(object sender, EventArgs e)
        {
            try
            {
                Cursor.Current = Cursors.WaitCursor;
                ClassPOBAL objBAL = new ClassPOBAL();
                objBAL.date1 = dateTimePicker20.Value;
                objBAL.date2 = dateTimePicker19.Value;
                ClassPODAL objDAL = new ClassPODAL();
                gridControl19.DataSource = null;
                if (objDAL.retreiveAllCashInReport(objBAL).Tables[0].Rows.Count > 0)
                {
                    gridControl19.DataSource = objBAL.DtDataSet.Tables[0];
                    //gridView1.Columns["Status"].FilterInfo = new ColumnFilterInfo("[Status] = '1'");
                    //gridView1.Columns["CustomerId"].Visible = false;
                    //gridView18.Columns["AttendanceIn"].DisplayFormat.FormatString = "yyyy/MM/dd hh:mm tt";
                    //gridView18.Columns["AttendanceOut"].DisplayFormat.FormatString = "yyyy/MM/dd hh:mm tt";
                    gridView19.OptionsView.ColumnAutoWidth = false;
                    gridView19.BestFitColumns();
                }
                Cursor.Current = Cursors.Default;
            ...
            try
            {
                ...
                using (SaveFileDialog saveDialog = new SaveFileDialog())
                {
                    ...
                    if (saveDialog.ShowDialog() != DialogResult.Cancel)
                    {
                        ...
                        {
                            case ".xls":
                                gridControl19.ExportToXls(exportFilePath);
                                break;
                            case ".xlsx":
                                gridControl19.ExportToXlsx(exportFilePath);
                                break;
                            case ".rtf":
                                gridControl19.ExportToRtf(exportFilePath);
                                break;
                            case ".pdf":
                                gridControl19.ExportToPdf(exportFilePath);
                                break;
                            case ".html":
                                gridControl19.ExportToHtml(exportFilePath);
                                break;
                            case ".mht":
                                gridControl19.ExportToMht(exportFilePath);
                                break;
                            default:
                                break;
                        }
        ...
        private void button68_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objDAL = new ClassPODAL();
                gridControl4.DataSource = null;
                if (objDAL.retreiveBranchwiseCancelSales(objBAL).Tables[0].Rows.Count > 0)
                {
                    gridControl4.DataSource = objBAL.DtDataSet.Tables[0];
                    //gridView4.Columns["CancelStatus"].FilterInfo = new ColumnFilterInfo("[CancelStatus] = '0'");
                    gridView4.Columns["CreatedDate"].DisplayFormat.FormatString = "yyyy/MM/dd hh:mm tt";
        ...
        private void button70_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ClassPOBAL objBAL = new ClassPOBAL();
                ClassPODAL objDAL = new ClassPODAL();
                gridControl20.DataSource = null;
                if (objDAL.retreiveAllCustomerChequeReport(objBAL).Tables[0].Rows.Count > 0)
                {
                    gridControl20.DataSource = objBAL.DtDataSet.Tables[0];
                    gridView20.OptionsView.ColumnAutoWidth = false;
                    gridView20.BestFitColumns();
                }
                Cursor.Current = Cursors.Default;
        ...
        private void button72_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ClassPODAL objDAL = new ClassPODAL();
                gridControl20.DataSource = null;
                if (objDAL.retreiveAllSupplierChequeReport(objBAL).Tables[0].Rows.Count > 0)
                {
                    gridControl20.DataSource = objBAL.DtDataSet.Tables[0];
                    gridView20.OptionsView.ColumnAutoWidth = false;
                    gridView20.BestFitColumns();
            ...
            try
            {
                ...
                using (SaveFileDialog saveDialog = new SaveFileDialog())
                {
                    ...
                    if (saveDialog.ShowDialog() != DialogResult.Cancel)
                    {
                        ...
                        {
                            case ".xls":
                                gridControl20.ExportToXls(exportFilePath);
                                break;
                            case ".xlsx":
                                gridControl20.ExportToXlsx(exportFilePath);
                                break;
                            case ".rtf":
                                gridControl20.ExportToRtf(exportFilePath);
                                break;
                            case ".pdf":
                                gridControl20.ExportToPdf(exportFilePath);
                                break;
                            case ".html":
                                gridControl20.ExportToHtml(exportFilePath);
                                break;
                            case ".mht":
                                gridControl20.ExportToMht(exportFilePath);
                                break;
                            default:
                                break;
                        }
